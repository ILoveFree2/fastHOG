...
// adepted for use in fasthog, dropped base class rectangle

#ifndef fltk_Widget_h
#define fltk_Widget_h

//#include "Style.h" // TODO needed?

namespace fltk {

class Widget;
class Window;
// class Symbol; // TODO needed?
// class FL_API Group; // TODO needed? // is now from class Window
...
//  Group* parent() const	{ return parent_; } // is always null
...
private:
  int x_, y_, w_, h_; // variables normally inherited by Rectangle
  const char*		label_;
//  const Symbol*		image_;
//  unsigned		flags_;
//  const Style*		style_;
